/* ============================================================
   DOM READY WRAPPER (Prevents race conditions)
============================================================ */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJpamphaGdlcHR0aXl3Y3R0cm51Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzEzMzgwMTUsImV4cCI6MjA4NjkxNDAxNX0.9eYFh7FumMs86l57sHh5I1E-3D1C3AuwHeGYxaDnfXs"; // keep public anon only
  ...
  /* ============================================================
     REVEAL ANIMATION (FIXES YOUR BLANK PAGE)
  ============================================================ */
  ...
  function updateCountdown() {
    ...
    if (distance <= 0) {
      countdownEl.innerHTML =
        "<h2 class='countdown-ended'>Time's Up</h2>";
      return;
    }
  ...
  if (registrationForm && supabaseClient) {
